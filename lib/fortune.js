...
Fortune.prototype.resource = function(name, schema, options, schemaCallback) {
  ...
  if (this.adapter.model(name)) {
   ...
   //Agregating custom types. Look for Fortune.prototype.customType
  for (var key in schema){
      var value = schema[key];
      if (value && typeof value == 'string' && this.customTypes[value]){
...
/*
 * Defines a custom type wich can be used in resource models.
